...
def ask_candidate(question:str, resume:Resume):
    ...
    6. Use simple plain text formatting.
    7. Do not use Markdown symbols like *, **, ##, or <br>.
    8. Use normal headings and bullet points.
    """
...
#Its a decorator... in get method what we write will descide what is display in home page
@app.get("/")
def home():
